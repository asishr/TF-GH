...
## Assumptions
* An Azure virtual network, subnets, public ip and resource group exist
...
* 2 Azure Load Balancer Backend Address Pool
* 3 Azure Load Balancer Outbound Rule
* 4 Azure Load Balancer Probe
* 5 Azure Load Balancer Rule
* 6 Azurerm Resource Group data source to access the Resource Group where the load balancer resources will be imported
* 7 Azure Public IP data source for the load balancer frontend ip configuration
